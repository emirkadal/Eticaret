...
namespace ETicaret.WebUI.Utils
{
    public class MailHelper
    {
        public static async Task<bool> SendMailAsync(Contact contact)
        {
            ...
            message.From = new MailAddress("imfo@siteadi.com");
            message.To.Add("bilgi@siteadi.com");
            message.Subject = "Siteden mesaj geldi.";
            message.Body = $"İsim: {contact.Name}- Soyisim: {contact.Surname}- E-Mail: {contact.Email}- Telefon: {contact.Phone}- Mesaj: {contact.Message}";
